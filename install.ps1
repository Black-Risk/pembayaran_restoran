...
Write-Host "Installing BR Resto Apps..."
$currentDir = Get-Location
$msixPath = ($currentDir.Path + "\" + "BR Resto Apps.sideload.msix")
...
if ($installProc.ExitCode -eq 0) {
	$app = Get-StartApps "BR Resto Apps"
	...
	if ($app) {
		Write-Host "Launching BR Resto Apps..."
